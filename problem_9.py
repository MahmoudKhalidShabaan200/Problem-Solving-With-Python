...
if(student_age >= 18) :
    ...
    print("SORRY \""+student_name+"\" , SORRY you can not take participation in the votting , because the age of the student is = "+str(student_age)+" years , and you need "+str(18 - student_age)+" years to take participation in the votting")