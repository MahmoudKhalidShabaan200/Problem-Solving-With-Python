...
# def checking_participation_in_votting(stud_name , stud_age) :
#     print("the name of the student is : \""+str(stud_name)+"\"")
#     print("the age of the student is : "+str(stud_age)+" years")
#     if(stud_age >= 18) :
#         print("HI \""+stud_name+"!\" OKAY , you can take participation in the votting , because the age of the student is = "+str(stud_age)+" years")
#     else :
#         print("SORRY \""+stud_name+"\" SORRY , you can not take participation in the votting , because the age of the student is = "+str(stud_age)+" years , and you need "+str(18 - stud_age)+" years to take participation in the votting")
# checking_participation_in_votting(student_name , student_age)
...
def checking_participation_in_votting(stud_name , stud_age) :
    ...
    if(stud_age >= 18) :
        ...
        return("SORRY \""+stud_name+"\" you can not take paricipation in the votting , because the age of the student is = "+str(stud_age)+" years , and you need "+str(18 - stud_age)+" years to take participation in the votting")
student_name = input("please enter the name of the student is : ")
student_age = float(input("please enter the age of the student is = "))
participation_in_votting = checking_participation_in_votting(student_name , student_age)
